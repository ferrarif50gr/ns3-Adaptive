...
{
public:
  std::map <Ptr<Packet>, Time> m_pktDelay;
//  std::map <int, Time> m_partialDelay;
  double partialDelay[602];
//  double *ptrpartialDelay;
  double partialPackets[602];
  double ss[602];
  double delayDeviation[602];
//  int *ptrpartialPackets;
  double totalDelay;
  double filteredAverageDelay[602];
  double globalAverageDelay;
